// icon:cross-1 | Radix Icons https://icons.radix-ui.com/ | WorkOS
import * as React from "react";

function IconCross1(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 15 15" height="1.75em" width="1.75em" {...props}>
      <path
        fill="currentColor"
        fillRule="evenodd"
